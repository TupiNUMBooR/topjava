...
public class MealsUtil {
    ...
    public static List<MealTo> getTos(Collection<Meal> meals, int caloriesPerDay) {
        return filterByPredicates(meals, caloriesPerDay, meal -> true, meal -> true);
    }
    ...
    public static List<MealTo> getFilteredTos(Collection<Meal> meals, int caloriesPerDay, LocalDate startDate, LocalDate endDate, LocalTime startTime, LocalTime endTime) {
        return filterByPredicates(meals, caloriesPerDay,
    ...
    private static List<MealTo> filterByPredicates(Collection<Meal> meals, int caloriesPerDay, Predicate<Meal> preFilter, Predicate<Meal> postFilter) {
